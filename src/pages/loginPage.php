...
<body class="flex flex-col bg-white h-screen bg-cover bg-center bg-no-repeat bg-mobs-bg">
    ...
    <div class="flex justify-center bg-opacity-80 bg-slate-500 items-center mb-20 p-5">
    ...
    <div class="flex bg-opacity-80 justify-center items-center bg-slate-500 mt-auto p-5">
